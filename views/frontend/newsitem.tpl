                                        ...
                                        <div class="rat-rad">
                                            {if isset($pools[0].already.answer)}
											    {if $k == $pools[0].already.answer}
												    <input type="radio" checked name="rating" value="{$k}" onclick="clickradio(this);"/>
												{else}
												    <input type="radio" name="rating" value="{$k}" onclick="clickradio(this);"/>
												{/if}
											{else}
											    {if $k == 0}<input type="radio" name="rating" checked value="{$k}" onclick="clickradio(this);"/>{else}<input type="radio" name="rating" value="{$k}" onclick="clickradio(this);"/>{/if}
											{/if}
            ...
            <div class="col-md-9 article-right news">
                <div class="article-right-block">
				    {if $lang == 'ru'}
                        ...
                        <img src="/documents/news/{$newsitem.poster}" alt="">
