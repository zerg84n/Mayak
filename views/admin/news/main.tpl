                                ...
                                <table class="table">
                                    ...
                                    <tbody>
										<tr id="adminrow-{$item.id}">
											...
											<td><a href="/news/article/{$item.id}/" target="_blank">{$item.title_ru}</a></td>
											<td><a href="/news/article/{$item.id}/" target="_blank">{$item.title_en}</a></td>
											<td style="color: #555555;">/news/article/{$item.id}/</td>
                                            <td>
