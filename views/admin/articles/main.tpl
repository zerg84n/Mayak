                                ...
                                <table class="table">
                                    ...
                                    <tbody>
										<tr id="adminrow-{$item.id}">
                                            <td style="font-size: 12px; color: #888888;">{$item.whenadd}<br />{$item.score} {$item.plural}</td>
											<td><a href="/articles/article/{$item.id}/" target="_blank">{$item.title_ru}</a></td>
											<td><a href="/articles/article/{$item.id}/" target="_blank">{$item.title_en}</a></td>
											<td style="color: #555555;">/articles/article/{$item.id}/</td>
                                            <td>
