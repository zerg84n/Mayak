<?php /* Smarty version Smarty-3.1.6, created on 2016-02-10 21:28:11
         compiled from "../views/admin/settings.tpl" */ ?>
<?php /*%%SmartyHeaderCode:153795488055b522c26ea401-44496876%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '153795488055b522c26ea401-44496876',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_55b522c287b15',
  'variables' => 
  array (
    'pricelists' => 0,
    'pl' => 0,
    ...
    'ss_error_text_ru' => 0,
    'ss_error_text_en' => 0,
    'ss_rules_expluatation_ru' => 0,
    'ss_rules_expluatation_en' => 0,
    'ss_legal_title' => 0,
    'ss_legal_address' => 0,
    'ss_address' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_55b522c287b15')) {function content_55b522c287b15($_smarty_tpl) {?>        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
...
">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="textarea-description" class="form-control" rows="3" name="error_text_ru"><?php echo $_smarty_tpl->tpl_vars['ss_error_text_ru']->value;?>
</textarea>
                            </div>
                            <div class="form-group">
                                <label>Текст на странице ошибки 404 (EN)</label>
                                <textarea id="textarea-description3" class="form-control" rows="3" name="error_text_en"><?php echo $_smarty_tpl->tpl_vars['ss_error_text_en']->value;?>
</textarea>
                            </div>
                            <div class="form-group">
                                <label>Правила ухода за лыжами (RU)</label>
                                <textarea id="textarea-description2" class="form-control" rows="3" name="rules_expluatation_ru"><?php echo $_smarty_tpl->tpl_vars['ss_rules_expluatation_ru']->value;?>
</textarea>
                            </div>
                            <div class="form-group">
                                <label>Правила ухода за лыжами (EN)</label>
                                <textarea id="textarea-description4" class="form-control" rows="3" name="rules_expluatation_en"><?php echo $_smarty_tpl->tpl_vars['ss_rules_expluatation_en']->value;?>
</textarea>
                            </div>
                        </div>
                        <!-- /.panel-body -->
